    ...
    return (
        ...
        >
            ...
            >
                ...
                <path
                    fill="#4CAF50"
                    d="M24 44c5.166 0 9.86-1.977 13.409-5.192l-6.19-5.238C29.145 35.091 26.686 36 24 36c-5.193 0-9.623-3.326-11.283-7.946l-6.522 5.025C9.505 39.556 16.227 44 24 44z"
                />
                <path
                    fill="#1976D2"
                    d="M43.611 20.083H42V20H24v8h11.303c-.793 2.237-2.231 4.166-4.084 5.57l.003-.002 6.19 5.238C36.972 38.403 44 33 44 24c0-1.341-.138-2.65-.389-3.917z"
                />
            </svg>
